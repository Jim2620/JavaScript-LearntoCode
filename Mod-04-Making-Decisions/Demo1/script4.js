...
let shipMethod = "UPS";
let shipWeight = 255; // in pounds"

//// INPUTS FROM USER ABOVE ////////////////////////

let shipCost;

// USPS       $2   /lb up to and including 10 lbs, then $1.75/lb afterwards
// UPS        $1.50/lb up to 100 lbs, $2.50 afterwards
// FedEx      $3/lb  0-10 lbs is $3/lb, 11-20 lbs is $2.75/lb, over 20 is $2.50/lb.
